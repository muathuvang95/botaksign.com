jQuery(function(){
	...
	//jQuery.get('scan.php', function(data) {
		...
		var data= jQuery.parseJSON(s3_browse_vars.json_array);
		...
		function render(data) {
			...
			if(scannedFiles.length) {
				...
				scannedFiles.forEach(function(f) {
					...
					var file = jQuery('<li class="files"><a href="'+ f.link+'" title="'+ name +'" class="files">'+icon+'<span class="name">'+ name +'</span> <span class="details">'+fileSize+'</span></a></li>');

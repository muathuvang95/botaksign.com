...
<div class="wrap">
    ...
    <div class="wrap">
        <h1 class="nbd-title">
            ...
            ?>   
            <?php add_thickbox(); ?>
            <a class="button thickbox" href="#TB_inline?width=300&height=160&inlineId=nbd-<?php esc_attr_e( $pid ); ?>"><?php esc_html_e('Add Template'); ?></a>
            <?php else: ?>
        ...
        <?php 
            if( count($variations) > 0 ):
        ?>
        <div id="nbd-<?php esc_attr_e( $pid ); ?>" style="display:none;">

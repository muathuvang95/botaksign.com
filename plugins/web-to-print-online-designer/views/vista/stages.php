                        ...
                        <div class="stage-guideline">
                            <div class="stage-guideline-inner" ng-show="settings.bleedLine">
                                <div style="position: relative; width: 100%; height: 100%;">
                                    <div ng-class="stage.config.area_design_type == '2' ? 'nbd-round' : ''" ng-show="stage.config.showBleed == '1'" class="bleed-line" ng-style="{'width' : calcStyle(stage.states.scaleRange[stage.states.currentScaleIndex].ratio * (stage.config.width - 2 * stage.config.bleed_lr)),
                                        ...
                                        'top' : calcStyle(stage.states.scaleRange[stage.states.currentScaleIndex].ratio * (stage.config.bleed_tb))}" style="border: 1px solid red;box-sizing: border-box;position: absolute;"></div>
                                    <div ng-class="stage.config.area_design_type == '2' ? 'nbd-round' : ''" ng-show="stage.config.showSafeZone == '1'" class="safe-line" ng-style="{'width' : calcStyle(stage.states.scaleRange[stage.states.currentScaleIndex].ratio * (stage.config.width - 2 * stage.config.bleed_lr - 2 * stage.config.margin_lr)),
                                        ...
                                        'top' : calcStyle(stage.states.scaleRange[stage.states.currentScaleIndex].ratio * (stage.config.bleed_tb+stage.config.margin_tb))}"
                                         style="border: 1px solid green;box-sizing: border-box;position: absolute;"></div>  
                                </div>                               
                            </div>
                        </div>
                    </div>

...
<!--    <a class="btn btn-primary shadow nbdesigner_upload ng-binding" href="<?php //echo wp_login_url( $redirect ); ?>">{{(langs['LOGIN']) ? langs['LOGIN'] : "Login"}}</a>-->
    ...
    <p style="font-size: 12px; opacity: 0.5; margin-top: 15px;" ng-hide="settings['ui_mode'] == 1"><a href="<?php echo wc_get_cart_url(); ?>"><i class="fa fa-long-arrow-left" aria-hidden="true"></i> Return to cart</a></p>
    <?php endif; ?> 
</div>

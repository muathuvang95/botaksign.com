...
<html lang="<?php echo $lang_code; ?>">
    <head>
        ...
        <?php 
            ...
            if( $task == 'reup' ){
                $list_file_upload = botak_get_list_files_upload_from_s3( 'reupload-design/'.$nbu_item_key );  // Custom Botak S3
            }else {
                $list_file_upload = '';
            }
        ...
        <script type="text/javascript">
            var NBDESIGNCONFIG = {
                user_id: "<?php echo get_current_user_id(); ?>", //Cs botak get user id
                ...
                item_id:        "<?php echo $item_id; ?>",                  // BOTAK custom reupload phase 3
                reupload:       "<?php echo $reupload; ?>",                 // BOTAK custom reupload phase 3

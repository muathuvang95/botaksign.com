...
<div id="nbdesigner-setting-container">
    ...
    <div>
        ...
        <?php //CS botak ?>
        <p class="nbd-option-top <?php if (!$enable) echo 'nbdesigner-disable'; ?>" id="nbd_design_help_status">
            <input type="hidden" value="0" name="_nbdesigner_design_help"/>
            <label for="_nbdesigner_design_help"><?php esc_html_e('Design help', 'web-to-print-online-designer'); ?></label>
            <input type="checkbox" value="1" name="_nbdesigner_design_help" id="_nbdesigner_design_help" <?php checked($enable_design_help); ?> class="short" /> 
        </p>
    ...
    <div id="nbd-setting-container" class="<?php if (!$enable) echo 'nbdesigner-disable'; ?>">
        ...
        <div id="nbd-custom-design" class="nbd-options-tab selected">
                    ...
                    <div class="nbdesigner-box-container">
                        <div class="nbdesigner-box">
                            ...
                            <div class="nbdesigner-setting-box-value">
                                <input name="_designer_setting[<?php esc_attr_e( $k ); ?>][orientation_name]" class="short orientation_name" 
                                       value="<?php esc_attr_e( $v['orientation_name'] ); ?>" type="text" required/>
                            </div>
                            <div class="nbdesigner-right">
                                ...
                                <a class="button nbdesigner-delete delete_orientation" data-index="<?php esc_attr_e( $k ); ?>" data-variation="com" onclick="NBDESIGNADMIN.deleteOrientation(this)">&times;</a>
                            </div>
                        </div>
                        <div class="nbdesigner-box nbdesigner-box-collapse" data-variation="com">
                            <div class="nbdesigner-image-box">
                                <div class="nbdesigner-image-inner">
                                    ...
                                    <div class="nbdesigner-image-original <?php if($v['bg_type'] == 'tran') echo "background-transparent"; ?>"
                                        style="width: <?php esc_attr_e( $style_width ); ?>px;
                                               height: <?php esc_attr_e( $style_height ); ?>px;
                                               left: <?php esc_attr_e( $style_left ); ?>px;
                                               top: <?php esc_attr_e( $style_top ); ?>px;
                                    ...
                                    <?php // CS botak overlay ?>
                                    <div class="nbdesigner-image-overlay"
                                        style="width: <?php esc_attr_e( $v['overlay_width'] ); ?>px;
                                               height: <?php esc_attr_e( $v['overlay_height'] ); ?>px;
                                               left: <?php esc_attr_e( $v['overlay_left'] ); ?>px;
                                               top: <?php esc_attr_e( $v['overlay_top'] ); ?>px;
                                               display: <?php esc_attr_e( $overlay_style ); ?>"
                                    >
                                        <?php
                                ...
                                <input type="hidden" class="hidden_img_src_left" name="_designer_setting[<?php esc_attr_e( $k ); ?>][img_src_left]" value="<?php esc_attr_e( $v['img_src_left'] ); ?>">
                                <input type="hidden" class="hidden_img_src_width" name="_designer_setting[<?php esc_attr_e( $k ); ?>][img_src_width]" value="<?php esc_attr_e( $v['img_src_width'] ); ?>">
                                <input type="hidden" class="hidden_img_src_height" name="_designer_setting[<?php esc_attr_e( $k ); ?>][img_src_height]" value="<?php esc_attr_e( $v['img_src_height'] ); ?>">
                                <input type="hidden" class="hidden_overlay_src" name="_designer_setting[<?php esc_attr_e( $k ); ?>][img_overlay]" value="<?php esc_attr_e( $v['img_overlay'] ); ?>">
                                <input type="hidden" class="hidden_nbd_version" name="_designer_setting[<?php esc_attr_e( $k ); ?>][version]" value="<?php esc_attr_e( $v['version'] ); ?>">
                                <input type="hidden" class="hidden_nbd_ratio" name="_designer_setting[<?php esc_attr_e( $k ); ?>][ratio]" value="<?php esc_attr_e( $ratio ); ?>">
                                <div>   
                                    <a class="button nbdesigner_move nbdesigner_move_left" data-index="<?php esc_attr_e( $k ); ?>" onclick="NBDESIGNADMIN.nbdesigner_move(this, 'left')">&larr;</a>
                                    <a class="button nbdesigner_move nbdesigner_move_right" data-index="<?php esc_attr_e( $k ); ?>" onclick="NBDESIGNADMIN.nbdesigner_move(this, 'right')">&rarr;</a>
                                    <a class="button nbdesigner_move nbdesigner_move_up" data-index="<?php esc_attr_e( $k ); ?>" onclick="NBDESIGNADMIN.nbdesigner_move(this, 'up')">&uarr;</a>
                                    <a class="button nbdesigner_move nbdesigner_move_down" data-index="<?php esc_attr_e( $k ); ?>" onclick="NBDESIGNADMIN.nbdesigner_move(this, 'down')">&darr;</a>
                                    <a class="button nbdesigner_move nbdesigner_move_center" data-index="<?php esc_attr_e( $k ); ?>" onclick="NBDESIGNADMIN.nbdesigner_move(this, 'center')">&frac12;</a>
                                    <a class="button nbdesigner_move nbdesigner_move_center nbd-admin-setting-fit-btn" data-index="<?php esc_attr_e( $k ); ?>" onclick="NBDESIGNADMIN.nbdesigner_move(this, 'fit')"><i class="mce-ico mce-i-dfw nbd-admin-setting-fit-icon" ></i></a>
                                </div>
                                <div class="nbb-background-group">
                                    <div>
                                        <p>
                                            ...
                                            <label class="nbdesigner-lbl-setting"><input type="radio" name="_designer_setting[<?php esc_attr_e( $k ); ?>][bg_type]" value="image" 
                                            ...
                                            <label class="nbdesigner-lbl-setting"><input type="radio" name="_designer_setting[<?php esc_attr_e( $k ); ?>][bg_type]" value="color" 
                                            ...
                                            <label class="nbdesigner-lbl-setting"><input type="radio" name="_designer_setting[<?php esc_attr_e( $k ); ?>][bg_type]" value="tran" 
                                    ...
                                    <div class="nbdesigner_bg_image" <?php if($v['bg_type'] != 'image') echo ' style="display: none;"' ?>>
                                        <a class="button nbdesigner-button nbdesigner-add-image" onclick="NBDESIGNADMIN.loadImage(this)" data-index="<?php esc_attr_e( $k ); ?>"><?php esc_html_e('Set image', 'web-to-print-online-designer'); ?></a>
                                        <?php 
                                        ...
                                        ?>
                                            ...
                                            <input type="hidden" class="nbd_origin_bg_pdf" value="<?php esc_attr_e( $v['origin_bg_pdf'] ); ?>" name="_designer_setting[<?php esc_attr_e( $k ); ?>][origin_bg_pdf]" />
                                            <a class="button nbdesigner-button nbdesigner-add-image" onclick="NBDESIGNADMIN.uploadPdfAsBackground(this)" data-index="<?php esc_attr_e( $k ); ?>"><?php esc_html_e('Set PDF as background image', 'web-to-print-online-designer'); ?></a>
                                    ...
                                    <div class="nbdesigner_bg_color" <?php if($v['bg_type'] != 'color') echo ' style="display: none;"' ?>>
                                        <input type="text" name="_designer_setting[<?php esc_attr_e( $k ); ?>][bg_color_value]" value="<?php esc_attr_e( $v['bg_color_value'] ); ?>" class="nbd-color-picker" />
                                    </div>
                                </div>
                                <div class="nbdesigner-clearfix"></div>
                                ...
                                <div class="nbd-admin-setting-include-background-wrap">
                                    ...
                                    <input type="hidden" value="0" name="_designer_setting[<?php esc_attr_e( $k ); ?>][include_background]"/>
                                    <input type="checkbox" value="1" name="_designer_setting[<?php esc_attr_e( $k ); ?>][include_background]"  <?php checked($include_background); ?>/>
                                ...
                                <div class="nbdesigner_overlay_box nbd-admin-setting-text-align-left" >
                                    ...
                                    <input type="hidden" value="0" name="_designer_setting[<?php esc_attr_e( $k ); ?>][show_overlay]" class="show_overlay"/>                   
                                    <input type="checkbox" value="1" 
                                        name="_designer_setting[<?php esc_attr_e( $k ); ?>][show_overlay]" id="_designer_setting[<?php esc_attr_e( $k ); ?>][bg_type]" <?php checked($v['show_overlay']); ?> 
                                    ...
                                    <p class="overlay-toggle" style="display: <?php if($v['show_overlay']) {echo 'block';} else {echo 'none';} ?>">
                                        <input type="hidden" value="0" name="_designer_setting[<?php esc_attr_e( $k ); ?>][include_overlay]" class="include_overlay"/> 
                                        <input type="checkbox" value="1"  class="include_overlay"
                                            name="_designer_setting[<?php esc_attr_e( $k ); ?>][include_overlay]"  <?php checked($v['include_overlay']); ?>   
                                            />
                                        <span><?php  esc_html_e('Include in final design', 'web-to-print-online-designer'); ?></span>
                                    </p>
                                    <input type="hidden" name="_designer_setting[<?php esc_attr_e( $k ); ?>][overlay_real_width]" value="<?php isset($v['overlay_real_width']) ? esc_attr_e( $v['overlay_real_width'] ) : 0 ; ?>" class="overlay_real_width" />
                                    <input type="hidden" name="_designer_setting[<?php esc_attr_e( $k ); ?>][overlay_real_height]" value="<?php isset($v['overlay_real_height']) ? esc_attr_e( $v['overlay_real_height'] ) : 0; ?>" class="overlay_real_height"/>
                                    <input type="hidden" name="_designer_setting[<?php esc_attr_e( $k ); ?>][overlay_real_top]" value="<?php isset($v['overlay_real_top']) ? esc_attr_e( $v['overlay_real_top'] ) : 0; ?>" class="overlay_real_top"/>
                                    <input type="hidden" name="_designer_setting[<?php esc_attr_e( $k ); ?>][overlay_real_left]" value="<?php isset($v['overlay_real_left']) ? esc_attr_e( $v['overlay_real_left'] ) : 0; ?>" class="overlay_real_left"/>
                                    <input type="hidden" name="_designer_setting[<?php esc_attr_e( $k ); ?>][overlay_width]" value="<?php isset($v['overlay_width']) ? esc_attr_e( $v['overlay_width'] ) : 0; ?>" class="overlay_width"/>
                                    <input type="hidden" name="_designer_setting[<?php esc_attr_e( $k ); ?>][overlay_height]" value="<?php isset($v['overlay_height']) ? esc_attr_e( $v['overlay_height'] ) : 0; ?>" class="overlay_height"/>
                                    <input type="hidden" name="_designer_setting[<?php esc_attr_e( $k ); ?>][overlay_top]" value="<?php isset($v['overlay_top']) ? esc_attr_e( $v['overlay_top'] ) : 0; ?>" class="overlay_top"/>
                                    <input type="hidden" name="_designer_setting[<?php esc_attr_e( $k ); ?>][overlay_left]" value="<?php isset($v['overlay_left']) ? esc_attr_e( $v['overlay_left'] ) : 0; ?>" class="overlay_left"/>
                                </div>
                                <!-- 
                                <div class="nbd_area_design_type">
                                    ...
                                    <label class="nbdesigner-lbl-setting"><input type="radio" name="_designer_setting[<?php esc_attr_e( $k ); ?>][area_design_type]" value="1" 
                                    ...
                                    <label class="nbdesigner-lbl-setting"><input type="radio" name="_designer_setting[<?php esc_attr_e( $k ); ?>][area_design_type]" value="2" 
                            ...
                            <div class="nbdesigner-info-box">
                                ...
                                <div class="nbdesigner-info-box-inner notice-width nbd-has-notice">
                                    ...
                                    <div>
                                        <input type="number" step="any" min="0" name="_designer_setting[<?php esc_attr_e( $k ); ?>][product_width]" 
                                               value="<?php esc_attr_e( $v['product_width'] ); ?>" class="short product_width" 
                                               onchange="NBDESIGNADMIN.change_dimension_product(this, 'width')"> <?php esc_html_e( $unit ); ?>
                                    </div>
                                </div>
                                <div class="nbdesigner-info-box-inner notice-height nbd-has-notice">
                                    ...
                                    <div>
                                        <input type="number" step="any" min="0" name="_designer_setting[<?php esc_attr_e( $k ); ?>][product_height]" 
                                               value="<?php esc_attr_e( $v['product_height'] ); ?>" class="short product_height"  
                                               onchange="NBDESIGNADMIN.change_dimension_product(this, 'height')"> <?php esc_html_e( $unit ); ?>
                                    </div>
                                </div> 
                                <p class="nbd-setting-section-title">
                                ...
                                <div class="nbdesigner-info-box-inner notice-width nbd-has-notice">
                                    ...
                                    <div>
                                        <input type="number" step="any" name="_designer_setting[<?php esc_attr_e( $k ); ?>][real_width]" value="<?php esc_attr_e( $v['real_width'] ); ?>" class="short real_width" 
                                               onchange="NBDESIGNADMIN.updateRelativePosition(this, 'width')"> <?php esc_html_e( $unit ); ?> 
                                    </div>
                                </div>
                                <div class="nbdesigner-info-box-inner notice-height nbd-has-notice">
                                    ...
                                    <div>
                                        <input type="number" step="any" min="0" name="_designer_setting[<?php esc_attr_e( $k ); ?>][real_height]" value="<?php esc_attr_e( $v['real_height'] ); ?>" class="short real_height"  
                                               onchange="NBDESIGNADMIN.updateRelativePosition(this, 'height')"> <?php esc_html_e( $unit ); ?> 
                                    </div>
                                </div>   
                                <div class="nbdesigner-info-box-inner notice-height nbd-has-notice">
                                    ...
                                    <div>
                                        <input type="number" step="any" min="0" name="_designer_setting[<?php esc_attr_e( $k ); ?>][real_top]" value="<?php esc_attr_e( $v['real_top'] ); ?>" class="short real_top"  
                                               onchange="NBDESIGNADMIN.updateRelativePosition(this, 'top')"> <?php esc_html_e( $unit ); ?> 
                                    </div>
                                </div> 
                                <div class="nbdesigner-info-box-inner">
                                    ...
                                    <div>
                                        <input type="number" step="any" min="0" name="_designer_setting[<?php esc_attr_e( $k ); ?>][real_left]" value="<?php esc_attr_e( $v['real_left'] ); ?>" class="short real_left"  
                                               onchange="NBDESIGNADMIN.updateRelativePosition(this, 'left')"> <?php esc_html_e( $unit ); ?> 
                                    </div>
                                </div>
                                <p class="nbd-setting-section-title">
                                ...
                                <div class="nbdesigner-info-box-inner">
                                    ...
                                    <div>
                                        <input type="number" step="any"  min="0" name="_designer_setting[<?php esc_attr_e( $k ); ?>][area_design_width]" 
                                               value="<?php esc_attr_e( $v['area_design_width'] ); ?>" class="short area_design_dimension area_design_width" data-index="width" 
                                ...
                                <div class="nbdesigner-info-box-inner">
                                    ...
                                    <div>
                                        <input type="number"  step="any" min="0" name="_designer_setting[<?php esc_attr_e( $k ); ?>][area_design_height]" value="<?php esc_attr_e( $v['area_design_height'] ); ?>" class="short area_design_dimension area_design_height" data-index="height" onchange="NBDESIGNADMIN.updatePositionDesignArea(this)">&nbsp;px
                                    </div>
                                </div>  
                                <div class="nbdesigner-info-box-inner">
                                    <label class="nbdesigner-setting-box-label"><?php esc_html_e('Left', 'web-to-print-online-designer'); ?></label>
                                    <div>
                                        <input type="number" step="any"  min="0" name="_designer_setting[<?php esc_attr_e( $k ); ?>][area_design_left]" value="<?php esc_attr_e( $v['area_design_left'] ); ?>" class="short area_design_dimension area_design_left" data-index="left" onchange="NBDESIGNADMIN.updatePositionDesignArea(this)">&nbsp;px
                                    </div>
                                </div>
                                <div class="nbdesigner-info-box-inner">
                                    <label class="nbdesigner-setting-box-label"><?php esc_html_e('Top', 'web-to-print-online-designer'); ?></label>
                                    <div>
                                        <input type="number" step="any"  min="0" name="_designer_setting[<?php esc_attr_e( $k ); ?>][area_design_top]" value="<?php esc_attr_e( $v['area_design_top'] ); ?>" class="short area_design_dimension area_design_top" data-index="top" onchange="NBDESIGNADMIN.updatePositionDesignArea(this)">&nbsp;px
                                    </div>
                                </div>  
                                <p class="nbd-setting-section-title"><?php esc_html_e('For paper/card', 'web-to-print-online-designer'); ?></p>

                                <!-- CS-V3 ADMIN OPTIONS SET BLEED AND SAFE -->

                                <div class="nbdesigner-info-box-inner" style="justify-content:flex-start;display:flex;align-items: center;">
                                    <label class="nbdesigner-setting-box-label"><?php esc_html_e('Show bleed', 'web-to-print-online-designer'); ?> <span class="nbd-bleed-notation"></span></label>
                                    <div>
                                        <input type="hidden" value="0" class="show_bleed" name="_designer_setting[<?php esc_attr_e( $k ); ?>][show_bleed]"/>
                                        <input type="checkbox" value="1" class="show_bleed" name="_designer_setting[<?php esc_attr_e( $k ); ?>][show_bleed]" <?php checked( $v['show_bleed'] ); ?> class="short nbd-dependence" data-target="#nbd-bleed<?php esc_attr_e( $k );?>" onchange="NBDESIGNADMIN.toggleBleed(this)"/> 
                                    </div>
                                </div>
                                
                                <div id="nbd-bleed<?php esc_attr_e( $k );?>" class="nbd-bleed-con <?php if (!$v['show_bleed']) echo 'nbdesigner-disable'; ?> nbd-independence">
                                    <div class="nbdesigner-info-box-inner" style="justify-content:space-between;display:flex;align-items: center;">
                                        <div>
                                            <label class="nbdesigner-setting-box-label"  style="width: 150px"><?php esc_html_e('Bleed top', 'web-to-print-online-designer'); ?></label>
                                            <input type="number" step="any" min="0" name="_designer_setting[<?php esc_attr_e( $k ); ?>][bleed_top]" value="<?php esc_attr_e( $v['bleed_top'] ); ?>" class="short bleed_top" onchange="NBDESIGNADMIN.updateBleed(this)">
                                        </div>
                                        <div>
                                            <label class="nbdesigner-setting-box-label"  style="width: 150px"><?php esc_html_e('Bleed bottom', 'web-to-print-online-designer'); ?></label>
                                            <input type="number" step="any" min="0" name="_designer_setting[<?php esc_attr_e( $k ); ?>][bleed_bottom]" value="<?php esc_attr_e( $v['bleed_bottom'] ); ?>" class="short bleed_bottom" onchange="NBDESIGNADMIN.updateBleed(this)">
                                        </div>
                                    </div>
                                    <div class="nbdesigner-info-box-inner" style="justify-content:space-between;display:flex;align-items: center;">
                                        <div>
                                            <label class="nbdesigner-setting-box-label"  style="width: 150px"><?php esc_html_e('Bleed left', 'web-to-print-online-designer'); ?></label>
                                            <input type="number" step="any"  min="0" name="_designer_setting[<?php esc_attr_e( $k ); ?>][bleed_left]" value="<?php esc_attr_e( $v['bleed_left'] ); ?>" class="short bleed_left" onchange="NBDESIGNADMIN.updateBleed(this)">
                                        </div>
                                        <div>
                                            <label class="nbdesigner-setting-box-label"  style="width: 150px"><?php esc_html_e('Bleed right', 'web-to-print-online-designer'); ?></label>
                                            <input type="number" step="any"  min="0" name="_designer_setting[<?php esc_attr_e( $k ); ?>][bleed_right]" value="<?php esc_attr_e( $v['bleed_right'] ); ?>" class="short bleed_right" onchange="NBDESIGNADMIN.updateBleed(this)">
                                        </div>
                                    </div>

                                    <div class="nbdesigner-info-box-inner" style="justify-content:flex-start;display:flex;align-items: center;">
                                        <label class="nbdesigner-setting-box-label"><?php esc_html_e('Bleed Corner', 'web-to-print-online-designer'); ?></label>

                                        <div style="padding-left: 15px; margin: 5px 0">
                                            ( Circle
                                            <input type="checkbox" value="1" class="bleed_corner" name="_designer_setting[<?php esc_attr_e( $k ); ?>][bleed_corner]" <?php checked( isset($v['bleed_corner'])?$v['bleed_corner'] : false ); ?> class="short nbd-dependence" onchange="NBDESIGNADMIN.toggleBleedCorner(this)"/> 
                                            )
                                        </div>
                                    </div>
                                    
                                    <div id="nbd-bleed-corner<?php esc_attr_e( $k );?>" class="nbd-bleed-corner nbd-independence">
                                        <div class="nbdesigner-info-box-inner" style="justify-content:space-between;display:flex;align-items: center;">
                                            <div>
                                                <label class="nbdesigner-setting-box-label round-cn-top"><img style="width: 40px; height:40px" src="<?php echo NBDESIGNER_PLUGIN_URL.'assets/images/round_corner/2-01.svg'; ?>"></label>
                                                <input style="margin-left: 10px"  type="number" step="any" min="0" name="_designer_setting[<?php esc_attr_e( $k ); ?>][bleed_corner_top]" value="<?php esc_attr_e( $v['bleed_corner_top'] ); ?>" class="short bleed_corner_top" onchange="NBDESIGNADMIN.updateBleed(this)">
                                            </div>
                                            <div>
                                                <label class="nbdesigner-setting-box-label round-cn-bottom"><img style="width: 40px; height:40px; padding-left: 60px" src="<?php echo NBDESIGNER_PLUGIN_URL.'assets/images/round_corner/3-01.svg'; ?>"></label>
                                                <input type="number" step="any" min="0" name="_designer_setting[<?php esc_attr_e( $k ); ?>][bleed_corner_bottom]" value="<?php esc_attr_e( $v['bleed_corner_bottom'] ); ?>" class="short bleed_corner_bottom" onchange="NBDESIGNADMIN.updateBleed(this)">
                                            </div>
                                        </div>
                                        <div class="nbdesigner-info-box-inner" style="justify-content:space-between;display:flex;align-items: center;">
                                            <div>
                                                <input type="number" style="margin-left: 10px" step="any"  min="0" name="_designer_setting[<?php esc_attr_e( $k ); ?>][bleed_corner_left]" value="<?php esc_attr_e( $v['bleed_corner_left'] ); ?>" class="short bleed_corner_left" onchange="NBDESIGNADMIN.updateBleed(this)">
                                                <label class="nbdesigner-setting-box-label round-cn-left"><img style="width: 40px; height:40px" src="<?php echo NBDESIGNER_PLUGIN_URL.'assets/images/round_corner/1-01.svg'; ?>"></label>
                                            </div>
                                            <div>
                                                <input type="number" step="any" style="margin-left: 10px"  min="0" name="_designer_setting[<?php esc_attr_e( $k ); ?>][bleed_corner_right]" value="<?php esc_attr_e( $v['bleed_corner_right'] ); ?>" class="short bleed_corner_right" onchange="NBDESIGNADMIN.updateBleed(this)">
                                                <label class="nbdesigner-setting-box-label round-cn-right"><img style="width: 40px; height:40px; padding-left: 70px" src="<?php echo NBDESIGNER_PLUGIN_URL.'assets/images/round_corner/4-01.svg'; ?>"></label>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="nbdesigner-info-box-inner" style="justify-content:flex-start;display:flex;align-items: center;">
                                    ...
                                    <div>
                                        <input type="hidden" value="0" class="show_safe_zone" name="_designer_setting[<?php esc_attr_e( $k ); ?>][show_safe_zone]"/>
                                        <input type="checkbox" value="1" class="show_safe_zone" name="_designer_setting[<?php esc_attr_e( $k ); ?>][show_safe_zone]" <?php checked( $v['show_safe_zone'] ); ?> class="short nbd-dependence" data-target="#nbd-safe-zone<?php esc_attr_e( $k );?>" onchange="NBDESIGNADMIN.toggleSafeZone(this)"/> 
                                    </div>
                                </div>

                                <div id="nbd-safe-zone<?php esc_attr_e( $k );?>" class="nbd-safe-zone-con <?php if (!$v['show_safe_zone']) echo 'nbdesigner-disable'; ?> nbd-independence">
                                    <div class="nbdesigner-info-box-inner" style="justify-content:space-between;display:flex;align-items: center;">
                                        <div>
                                            <label class="nbdesigner-setting-box-label" style="width: 150px"><?php esc_html_e('Magin top', 'web-to-print-online-designer'); ?></label>
                                            <input type="number" step="any"  min="0" name="_designer_setting[<?php esc_attr_e( $k ); ?>][margin_top]" value="<?php esc_attr_e( $v['margin_top'] ); ?>" class="short  margin_top" onchange="NBDESIGNADMIN.updateSafeZone(this)">
                                        </div>
                                        <div>
                                            <label class="nbdesigner-setting-box-label" style="width: 150px"><?php esc_html_e('Magin bottom', 'web-to-print-online-designer'); ?></label>
                                            <input type="number" step="any"  min="0" name="_designer_setting[<?php esc_attr_e( $k ); ?>][margin_bottom]" value="<?php esc_attr_e( $v['margin_bottom'] ); ?>" class="short  margin_bottom" onchange="NBDESIGNADMIN.updateSafeZone(this)">
                                        </div>
                                    </div>
                                    <div class="nbdesigner-info-box-inner" style="justify-content:space-between;display:flex;align-items: center;">
                                        <div>
                                            <label class="nbdesigner-setting-box-label" style="width: 150px"><?php esc_html_e('Magin left', 'web-to-print-online-designer'); ?></label>
                                            <input type="number" step="any"  min="0" name="_designer_setting[<?php esc_attr_e( $k ); ?>][margin_left]" value="<?php esc_attr_e( $v['margin_left'] ); ?>" class="short  margin_left" onchange="NBDESIGNADMIN.updateSafeZone(this)">
                                        </div>
                                        <div>
                                            <label class="nbdesigner-setting-box-label" style="width: 150px"><?php esc_html_e('Magin right', 'web-to-print-online-designer'); ?></label>
                                            <input type="number" step="any"  min="0" name="_designer_setting[<?php esc_attr_e( $k ); ?>][margin_right]" value="<?php esc_attr_e( $v['margin_right'] ); ?>" class="short  margin_right" onchange="NBDESIGNADMIN.updateSafeZone(this)">
                                        </div>
                                    </div>

                                    <div class="nbdesigner-info-box-inner" style="justify-content:flex-start;display:flex;align-items: center;">
                                        <label class="nbdesigner-setting-box-label"><?php esc_html_e('Safe Corner', 'web-to-print-online-designer'); ?></label>
                                        <div style="padding-left: 15px; margin: 5px 0">
                                            ( Circle
                                            <input style="margin-top: -5px" type="checkbox" value="1" class="safe_corner" name="_designer_setting[<?php esc_attr_e( $k ); ?>][safe_corner]" <?php checked( isset($v['safe_corner'])?$v['safe_corner'] : false); ?> class="short nbd-dependence" onchange="NBDESIGNADMIN.toggleSafeCorner(this)"/>
                                            )
                                        </div>
                                    </div>
                                    <div id="nbd-safe-corner<?php esc_attr_e( $k );?>" class="nbd-safe-corner nbd-independence">
                                        <div class="nbdesigner-info-box-inner" style="justify-content:space-between;display:flex;align-items: center;">
                                            <div>
                                                <label class="nbdesigner-setting-box-label round-cn-top"><img style="width: 40px; height:40px" src="<?php echo NBDESIGNER_PLUGIN_URL.'assets/images/round_corner/2-01.svg'; ?>"></label>
                                                <input  style="margin-left: 10px" type="number" step="any" min="0" name="_designer_setting[<?php esc_attr_e( $k ); ?>][safe_corner_top]" value="<?php esc_attr_e( $v['safe_corner_top'] ); ?>" class="short safe_corner_top" onchange="NBDESIGNADMIN.updateSafeZone(this)">
                                            </div>
                                            <div>
                                                <label class="nbdesigner-setting-box-label round-cn-bottom"><img style="width: 40px; height:40px; padding-left: 60px;" src="<?php echo NBDESIGNER_PLUGIN_URL.'assets/images/round_corner/3-01.svg'; ?>"></label>
                                                <input type="number" step="any" min="0" name="_designer_setting[<?php esc_attr_e( $k ); ?>][safe_corner_bottom]" value="<?php esc_attr_e( $v['safe_corner_bottom'] ); ?>" class="short safe_corner_bottom" onchange="NBDESIGNADMIN.updateSafeZone(this)">
                                            </div>
                                        </div>
                                        <div class="nbdesigner-info-box-inner" style="justify-content:space-between;display:flex;align-items: center;">
                                            <div>
                                                <input style="margin-left: 10px" type="number" step="any"  min="0" name="_designer_setting[<?php esc_attr_e( $k ); ?>][safe_corner_left]" value="<?php esc_attr_e( $v['safe_corner_left'] ); ?>" class="short safe_corner_left" onchange="NBDESIGNADMIN.updateSafeZone(this)">
                                                <label class="nbdesigner-setting-box-label round-cn-left"><img style="width: 40px; height:40px" src="<?php echo NBDESIGNER_PLUGIN_URL.'assets/images/round_corner/1-01.svg'; ?>"></label>
                                            </div>
                                            <div>
                                                <input type="number" step="any"  min="0" name="_designer_setting[<?php esc_attr_e( $k ); ?>][safe_corner_right]" value="<?php esc_attr_e( $v['safe_corner_right'] ); ?>" class="short safe_corner_right" onchange="NBDESIGNADMIN.updateSafeZone(this)">
                                                <label class="nbdesigner-setting-box-label round-cn-right"><img style="width: 40px; height:40px; padding-left: 60px;" src="<?php echo NBDESIGNER_PLUGIN_URL.'assets/images/round_corner/4-01.svg'; ?>"></label>
                                            </div>
                                        </div>
                                    </div>
                                </div>
            ...
            <?php $count++; endforeach; ?>
                <input type="hidden" value="<?php esc_attr_e( $count ); ?>" id="nbdesigner-count-box"/>
            </div>
            <div id="nbdesigner-option" class="nbdesigner-option">
                ...
                <div class="nbdesigner-opt-inner">
                    ...
                    <input name="_nbdesigner_option[layout]" id="nbd_layout_modern" value="m" type="radio" <?php checked( $editor_layout, 'm'); ?> /><label for="nbd_layout_modern nbd-admin-setting-layout-label" ><?php esc_html_e('Modern ( recommended )', 'web-to-print-online-designer'); ?></label>
                    <input name="_nbdesigner_option[layout]" id="nbd_layout_visual" value="v" type="radio" <?php checked( $editor_layout, 'v'); ?> /><label for="nbd_layout_visual nbd-admin-setting-layout-label" ><?php esc_html_e('Visual', 'web-to-print-online-designer'); ?></label>
                    <input name="_nbdesigner_option[layout]" id="nbd_layout_classic" value="c" type="radio" <?php checked( $editor_layout, 'c'); ?> /><label for="nbd_layout_classic nbd-admin-setting-layout-label" ><?php esc_html_e('Classic', 'web-to-print-online-designer'); ?></label>
                </div>
                <div class="nbdesigner-opt-inner">
                                    ...
                                    <tr valign="top">
                                        ...
                                        <td class="forminp-text">
                                            ...
                                            <?php foreach ($variations as $variation): ?>
                                                <option value="<?php esc_attr_e( $variation['id'] ); ?>"><?php esc_html_e( $variation['name'] ); ?></option>
                                            <?php endforeach; ?>
                                            </select>
                                        </td>
                                    </tr>
                                </table>
                                <p class="nbd-admin-setting-text-align-center"><a class="button button-primary nbd-create" href="<?php esc_attr_e( $link_create_template ); ?><?php echo '&variation_id='.$variations[0]['id'];  ?>" data-href="<?php esc_attr_e( $link_create_template ); ?>"><?php esc_html_e("Create template", 'web-to-print-online-designer'); ?></a></p>
                            </div>  
                            <script>
                ...
                <div id="nbd-global-template-cat" class="nbdesigner-opt-inner nbd-independence <?php if (!$option['global_template']) echo 'nbdesigner-disable'; ?>">
                    ...
                    <?php
                        ...
                        foreach ($cats as $cat):
                    ?>
                    <option value="<?php esc_attr_e( $cat->id ); ?>" <?php selected( $option['global_template_cat'], $cat->id ); ?>><?php esc_html_e( $cat->name ); ?></option>
                    <?php endforeach; ?>
                    </select>
                ...
                <div class="nbdesigner-opt-inner">
                    <div>
                        ...
                        <input name="_nbdesigner_option[dpi]" id="nbdesigner_dpi" value="<?php esc_attr_e( $option['dpi'] );?>" type="number"  min="72" class="nbd-admin-setting-dpi">&nbsp;
                    </div>
                </div>
                <div class="nbdesigner-opt-inner" style="display: none;">
                    ...
                    <input type="number" step="any" class="short nbdesigner-short-input wc_input_price" id="_nbdesigner_customprice" name="_nbdesigner_option[extra_price]" value="<?php esc_attr_e( $option['extra_price'] ); ?>"/>
                ...
                <div id="nbd-custom-size" class="<?php if (!$option['allow_specify_dimension']) echo 'nbdesigner-disable'; ?> nbd-independence nbdesigner-opt-inner">
                    ...
                    <div id="nbd-custom-size-free" class="<?php if ($option['type_dimension'] != 1) echo 'nbdesigner-disable'; ?> nbd-untarget">
                        <div class="nbdesigner-opt-inner">
                            <label class="nbdesigner-option-label"><?php esc_html_e('Min', 'web-to-print-online-designer'); ?> (<?php esc_html_e( $unit ); ?>)</label>
                            <?php esc_html_e('Width', 'web-to-print-online-designer'); ?>: <input type="number" step="any" class="short nbdesigner-short-input" name="_nbdesigner_option[min_width]" value="<?php esc_attr_e( $option['min_width'] ); ?>"/>
                            <?php esc_html_e('Height', 'web-to-print-online-designer'); ?>: <input type="number" step="any" class="short nbdesigner-short-input" name="_nbdesigner_option[min_height]" value="<?php esc_attr_e( $option['min_height'] ); ?>"/>
                        </div>
                        <div class="nbdesigner-opt-inner">
                            <label class="nbdesigner-option-label"><?php esc_html_e('Max', 'web-to-print-online-designer'); ?> (<?php esc_html_e( $unit ); ?>)</label>
                            <?php esc_html_e('Width', 'web-to-print-online-designer'); ?>: <input type="number" step="any" class="short nbdesigner-short-input" name="_nbdesigner_option[max_width]" value="<?php esc_attr_e( $option['max_width'] ); ?>"/>
                            <?php  esc_html_e('Height', 'web-to-print-online-designer'); ?>: <input type="number" step="any" class="short nbdesigner-short-input" name="_nbdesigner_option[max_height]" value="<?php esc_attr_e( $option['max_height'] ); ?>"/>
                        </div>
                    </div>
                    <div id="nbd-custom-size-defined" class="<?php if ($option['type_dimension'] != 2) echo 'nbdesigner-disable'; ?> nbd-untarget">
                        <?php foreach ($option['defined_dimension'] as $key => $dim): ?>
                            <div class="nbdesigner-opt-inner nbd-defined-size">
                                <?php esc_html_e('Width', 'web-to-print-online-designer'); ?>: <input type="number" step="any" class="short nbdesigner-short-input nbd-defined-width" name="_nbdesigner_option[defined_dimension][<?php esc_attr_e( $key ); ?>][width]" value="<?php esc_attr_e( $dim['width'] ); ?>"/>
                                <?php esc_html_e('Height', 'web-to-print-online-designer'); ?>: <input type="number" step="any" class="short nbdesigner-short-input nbd-defined-height" name="_nbdesigner_option[defined_dimension][<?php esc_attr_e( $key ); ?>][height]" value="<?php esc_attr_e( $dim['height'] ); ?>"/>
                                <?php esc_html_e('Extra price', 'web-to-print-online-designer'); ?>: <input type="number" step="any" class="short nbdesigner-short-input nbd-defined-price" name="_nbdesigner_option[defined_dimension][<?php esc_attr_e( $key ); ?>][price]" value="<?php esc_attr_e( $dim['price'] ); ?>"/>
                    ...
                    <div class="nbdesigner-opt-inner nbd-price-per-page <?php if ($option['dynamic_side'] != 1) echo 'nbdesigner-disable'; ?>">
                        ...
                        <input type="number" step="any" class="short nbdesigner-short-input wc_input_price" name="_nbdesigner_option[price_per_page]" value="<?php if(isset($option['price_per_page'])) esc_attr_e( $option['price_per_page'] ); else echo '0'; ?>"/>
                    </div>
                </div>  
                <div class="nbdesigner-opt-inner">
        ...
        <div id="nbd-upload-design" class="nbd-options-tab nbd-admin-setting-padding-10" >
            <p class="nbd-option-top">
                <input type="hidden" value="0" name="_designer_upload_cs"/>
                <label for="_designer_upload_cs"><?php esc_html_e('Use custom setting', 'web-to-print-online-designer'); ?></label>
                <input type="checkbox" value="1" name="_designer_upload_cs" id="_designer_upload_cs" <?php checked($setting_upload_cs); ?> class="short" />
            </p>
            <div id="nbd_setting_options" class="<?php if (!$setting_upload_cs) echo 'nbdesigner-disable'; ?>">

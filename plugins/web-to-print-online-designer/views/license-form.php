    ...
    <table class="form-table">
        <tr valign="top" class="" id="nbdesigner_license" <?php if(isset($license['key'])) echo 'style="display: none;"'; ?>>
            ...
            <td class="forminp-text">
                ...
                <input type="hidden" name="nbdesigner[domain]" value="<?php esc_attr_e( $site_url ); ?>"/>
                <input type="hidden" name="nbdesigner[title]" value="<?php esc_attr_e( $site_title ); ?>"/>
        ...
        <tr valign="top" class="" id="nbdesigner_active_license">
            ...
            <td class="forminp-text">
                <input class="regular-text" type="text" id="nbdesigner_input_key" name="nbdesigner[license]" placeholder="Enter your key" value="<?php if(isset($license['key'])) esc_attr_e( $license['key'] ); ?>" <?php if(isset($license['key'])) echo ' readonly'; ?>/>

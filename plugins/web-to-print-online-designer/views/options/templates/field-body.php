...
<?php echo '<script type="text/ng-template" id="field_body">'; ?>
    ...
    <?php endif; ?>
        <div class="tab-general nbd-field-content active">
            ...
            <ng-include src="'field_body_agreement_clause'"></ng-include>
...
<!--                                    <option ng-repeat="cf in options.fields | filter: { id: '!' + field.id }" value="{{cf.id}}">{{cf.general.title.value}}</option>-->
        ...
        <div class="tab-appearance nbd-field-content">
            <div class="nbd-field-info" ng-repeat="(key, data) in field.appearance" ng-if="key !== 'change_image_product'" ng-show="!field.nbd_type || (field.nbd_type && field.nbd_type !== 'terms_conditions')"> <?php //CS botak hidden change gallery image optio ?>
                <div class="nbd-field-info-1">
            ...
            <div class="nbd-field-info" ng-repeat="(key, data) in field.appearance" ng-if="key !== 'change_image_product'" ng-show="data.title =='CSS Class' && field.nbd_type && field.nbd_type == 'terms_conditions'"> <?php //CS botak hidden change gallery image optio ?>
                <div class="nbd-field-info-1">
                    <div><label><b>{{data.title}}</b> <nbd-tip ng-if="data.description != ''" data-tip="{{data.description}}" ></nbd-tip></label></div>
                </div> 
                <div class="nbd-field-info-2">

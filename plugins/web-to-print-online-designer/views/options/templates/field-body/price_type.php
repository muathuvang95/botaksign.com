...
<?php echo '<script type="text/ng-template" id="field_body_price_type">'; ?>
    <div class="nbd-field-info" ng-show="check_depend(field.general, field.general.price_type) && field.nbd_type !== 'size' && field.nbd_type !== 'dimension'"> <?php //CS botak break price for measure?>

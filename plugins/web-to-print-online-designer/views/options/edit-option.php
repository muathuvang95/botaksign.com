                    ...
                    <div id="postbox-container-1" class="postbox-container">
                        ...
                        <div id="product_catdiv" class="postbox">
                            ...
                            <div class="inside">
                                ...
                                <?php //CS botak ?>
                                <label for="apply_services"><?php _e('Services', 'web-to-print-online-designer'); ?>
                                    <input class="nbo-toggle-nav" data-toggle="#nbo-services-wrap" type="radio" id="apply_services" name="apply_for" value="s" <?php checked($options['apply_for'], 's') ?>/>  
                                </label>
                            </div>
                            ...
                            <div class="inside">
                                <div>
                                    ...
                                    <div class="nbd-section-wrap">
                                        ...
                                        <a title="<?php _e('Terms & Condittions', 'web-to-print-online-designer'); ?>" class="nbd-field-btn button" ng-click="add_field('terms_conditions')"><?php _e('Terms & Condittions', 'web-to-print-online-designer'); ?> <span class="nbo-type-label default">32</span></a>
                                    </div>
                                </div>
                                <div style="margin-top: 10px;">
                                    ...
                                    <div class="nbd-section-wrap">
                                        ...
                                        <a class="nbd-field-btn button" ng-click="add_field('pricing_rates')"><?php _e('Pricing Rates', 'web-to-print-online-designer'); ?> <span class="nbo-type-label wod">13</span></a> <?php //CS botak add custom option ?>
                                        <a class="nbd-field-btn button" ng-click="add_field('production_time')"><?php _e('Production Time', 'web-to-print-online-designer'); ?> <span class="nbo-type-label wod">14</span></a> <?php //CS botak add custom option ?>
                                        <a class="nbd-field-btn button" ng-click="add_field('calculation_option')"><?php _e('Calculation Option', 'web-to-print-online-designer'); ?> <span class="nbo-type-label wod">15</span></a> <?php //CS botak add custom option ?>
                                    </div>
                                </div>
                                <div style="margin-top: 10px;">
                                ...
                                <div>
                                    ...
                                    <p>
                                        ...
                                        <span class="nbo-type-label wod">13</span> 

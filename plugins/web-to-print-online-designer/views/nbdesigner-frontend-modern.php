...
?>
<html lang="<?php esc_attr_e( $lang_code ); ?>">
    <head>
        <?php
            /* Meta data */
        ...
        <link href='https://fonts.googleapis.com/css?family=<?php esc_attr_e( $_default_font ); ?>:400,400i,700,700i' rel='stylesheet' type='text/css'>
...
<!--        <link type="text/css" href="<?php echo NBDESIGNER_PLUGIN_URL .'assets/css/bundle.css'; ?>" rel="stylesheet" media="all"/>-->
        ...
        <link type="text/css" href="<?php echo NBDESIGNER_PLUGIN_URL."/assets/css/payment-form.css"; ?>" rel="stylesheet" media="all">
        <?php if(is_rtl()): ?>
        ...
        <?php 
            ...
            $item_id = (isset($_GET['item_id']) &&  $_GET['item_id'] != '') ? wc_clean( $_GET['item_id'] ) : '';                    // BOTAK custom reupload phase 3
            $reupload = (isset($_GET['reupload']) &&  $_GET['reupload'] != '') ? wc_clean( $_GET['reupload'] ) : '';                // BOTAK custom reupload phase 3
...
//            }
    ...
    <body ng-app="nbd-app" class="nbd-mode-modern nbd-mode-<?php esc_attr_e( $ui_mode ); ?> <?php echo (is_rtl()) ? 'nbd-modern-rtl' : '';?> <?php if( $is_iphone ) echo 'iphone'; ?>">     
        ...
        <?php if( nbdesigner_get_option('nbdesigner_enable_text_check_lang', 'no') == 'yes' ): ?>

<div class="nbd-sidebar">
    <?php
        ...
        $active_photos = (!$active_design && $settings["nbdesigner_enable_image"] == "yes") ? true : false;
        $active_product = ($show_nbo_option && !$active_design && !$active_photos && $settings['nbdesigner_display_product_option'] == '2' && !wp_is_mobile()) ? true : false;
        $active_template = (!$active_product && !$active_design && !$active_photos && $product_data["option"]['admindesign'] == "1") ? true : false;
        $active_typos = (!$active_product && !$active_design && !$active_photos && $product_data["option"]['admindesign'] == "0" && $settings["nbdesigner_enable_text"] == "yes") ? true : false;
        $active_cliparts = (!$active_product && !$active_design && !$active_photos && !$active_typos && $settings["nbdesigner_enable_clipart"] == "yes" && !$active_template) ? true : false;

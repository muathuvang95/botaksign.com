            ...
            <div class="stage-main-wrap">
                <div class="stage-main" ng-class="stage.config.bgType == 'image' ? 'nbd-without-shadow' : ''" ng-style="{'width' : calcStyle(stage.config.cwidth * stage.states.scaleRange[stage.states.currentScaleIndex].ratio),
                    ...
                    <div class="stage-overlay" ng-style="{'width' : calcStyle(stage.config.width * stage.states.scaleRange[stage.states.currentScaleIndex].ratio),
                        'height' : calcStyle(stage.config.height * stage.states.scaleRange[stage.states.currentScaleIndex].ratio),
                        'top' : calcStyle(stage.config.overlay_top * stage.states.scaleRange[stage.states.currentScaleIndex].ratio + offsetDesignWrap),
                        'left' : calcStyle(stage.config.overlay_left * stage.states.scaleRange[stage.states.currentScaleIndex].ratio + offsetDesignWrap)}">
...
'top' : calcStyle(stage.states.scaleRange[stage.states.currentScaleIndex].ratio * (stage.config.bleed_t)),
'bottom' : calcStyle(stage.states.scaleRange[stage.states.currentScaleIndex].ratio * (stage.config.bleed_b)),
'border-top-left-radius' : calcStyle(stage.config.bleed_radius_top ? stage.states.scaleRange[stage.states.currentScaleIndex].ratio * stage.config.bleed_radius_top : 0) ,
'border-top-right-radius' : calcStyle(stage.config.bleed_radius_left ? stage.states.scaleRange[stage.states.currentScaleIndex].ratio * stage.config.bleed_radius_left : 0),
...
'right' : calcStyle(stage.states.scaleRange[stage.states.currentScaleIndex].ratio * (stage.config.bleed_r  + stage.config.margin_r)),
'top' : calcStyle(stage.states.scaleRange[stage.states.currentScaleIndex].ratio * (stage.config.bleed_t  + stage.config.margin_t)),
'border-top-left-radius' : calcStyle(stage.config.hasOwnProperty( 'safe_radius_top' )? ((stage.states.scaleRange[stage.states.currentScaleIndex].ratio * stage.config.safe_radius_top > 0) ? (stage.states.scaleRange[stage.states.currentScaleIndex].ratio * stage.config.safe_radius_top) : 0) : 0 ) ,
...
'bottom' : calcStyle(stage.states.scaleRange[stage.states.currentScaleIndex].ratio * (stage.config.bleed_b  + stage.config.margin_b))}"></div>
    ...
    <div class="nbd-guidelines-notice">
        <div ng-show="settings.bleedLine && !settings.is_mobile" class="nbd-guideline-bleedline" >
            <span class="nbd-popup-trigger" data-popup="popup-nbd-bleedline-popup"><?php esc_html_e('Bleed line','web-to-print-online-designer'); ?> <i class="icon-nbd icon-nbd-info-circle"></i></span>
        </div>

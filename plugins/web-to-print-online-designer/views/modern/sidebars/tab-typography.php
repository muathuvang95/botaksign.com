    ...
    <div class="tab-main tab-scroll">
        <div class="typography-head">
            ...
            <div class="head-main">
                ...
                <span ng-click="addText('<?php esc_html_e('Add a little bit of body text','web-to-print-online-designer'); ?>')" class="text-body" ><?php esc_html_e('Add a little bit of body text','web-to-print-online-designer'); ?></span>

        ...
        public static function get_options() {
            return apply_filters('nbdesigner_general_settings', array(
                'general-settings' => array(
                    array(
                        ...
                        'options'       => array(
                            ...
                            'c' => esc_html__('Classic', 'web-to-print-online-designer')
                        )
                    ),
                    array(
                    ...
                    array(
                        'title'         => esc_html__('Hide On Smartphones', 'web-to-print-online-designer'),
                        'description'   => esc_html__('Hide product designer on smartphones and display an information instead.', 'web-to-print-online-designer'),
                    ...
                    array(
                        'title'         => esc_html__('Allow customer re-design after order', 'web-to-print-online-designer'),
                ...
                'application'       => array(
                    ...
                    array(
                        'title'         => esc_html__( 'Dropbox App ID', 'web-to-print-online-designer'),
                    ...
                    array(
                        ...
                        'description'   => esc_html__( 'That feature allow the customer serach and use icons from Flaticon.', 'web-to-print-online-designer').' <a href="https://developer.flaticon.com/" target="_blank">' . esc_html__("Where do I get the Flaticon API Key?", 'web-to-print-online-designer').'</a>',

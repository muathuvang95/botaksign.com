            ...
            return apply_filters('nbdesigner_laucher_settings', array(
                'general' => array(
                    array(
                        ...
                        'description'   => sprintf(__( 'Allow customers become designers who create and sell their designs. After "Save options" go to <a target="_blank" href="%s">Permalink</a> and "Save changes"', 'web-to-print-online-designer'), esc_url(admin_url('options-permalink.php'))),
                        'default'       => 'no',
                        'type'          => 'radio',
                        'options'       => array(

...
if( !class_exists('Nbdesigner_Printing_Options') ) {
    class Nbdesigner_Printing_Options{
        public static function get_options() {
            return apply_filters('nbdesigner_printing_options_settings', array(
                'general' => array(
                    ...
                    array(
                        'title'         => esc_html__( 'Product Time Default', 'web-to-print-online-designer'),
                        'id'            => 'nbdesigner_product_time_default',
                        'description'   => __( 'Set default production timing', 'web-to-print-online-designer' ),
                        'default'       => self::default_pt(),
                        'col1'          => esc_html__( 'Quantity', 'web-to-print-online-designer'),
                        'col2'          => esc_html__( 'Time (Hours)', 'web-to-print-online-designer'),
        ...
        public static function default_pt(){

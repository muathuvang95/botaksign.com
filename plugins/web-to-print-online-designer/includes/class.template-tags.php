        ...
        public function gallery_tag_filter(){
            ...
            if( $search != '' ){
                ...
                <span class="nbd-gallery-filter-tag">
                    <span class="nbd-filter-tag-name"><?php esc_html_e( $search ); ?></span>
            ...
            if( count( $tags ) ){
                ...
                ?>
                <span class="nbd-gallery-filter-tag">
                    <span class="nbd-filter-tag-name"><?php esc_html_e( $_tag->name ); ?></span>
                    <span class="nbd-filter-tag-remove" data-type="tag" data-value="<?php esc_attr_e( $_tag->term_id ); ?>">
                        <svg version="1.1" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                            <path d="M18.984 6.422l-5.578 5.578 5.578 5.578-1.406 1.406-5.578-5.578-5.578 5.578-1.406-1.406 5.578-5.578-5.578-5.578 1.406-1.406 5.578 5.578 5.578-5.578z"></path>
                        </svg>
                    </span>
            ...
            if( $colors != '' ){
                ...
                ?>
                <span class="nbd-gallery-filter-tag">
                    <span class="nbd-filter-color" style="background: #<?php esc_attr_e( $_color ); ?>;"></span>
                    <span class="nbd-filter-tag-remove" data-type="color" data-value="<?php esc_attr_e( $_color ); ?>">
                        <svg version="1.1" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                            <path d="M18.984 6.422l-5.578 5.578 5.578 5.578-1.406 1.406-5.578-5.578-5.578 5.578-1.406-1.406 5.578-5.578-5.578-5.578 1.406-1.406 5.578 5.578 5.578-5.578z"></path>
                        </svg>
                    </span>

            ...
            <div class="nbd-setup-shipping-unit">
                <p>
                    <label for="nbdesigner_license">
                        <?php 
                            printf( wp_kses(
                                __( '<strong>License key</strong>—get your <a target="_blank" href="%s">premium license key</a>', 'web-to-print-online-designer'),
                ...
                <?php if( $license['key'] == '' ): ?>
                <p><label for="nbdesigner_license"><strong><?php esc_html_e('Get free license key', 'web-to-print-online-designer'); ?></strong></label></p>
                <div class="get-license-container" id="get-license-container">
                    ...
                    <div>
                        ...
                        <input id="license-title" type="hidden" name="nbdesigner[title]" value="<?php esc_attr_e( $site_title ); ?>"/>
                ...
                <select id="font_subset" name="nbdesigner_default_font_subset" class="wc-enhanced-select">
                    ...
                    <option value="<?php esc_attr_e( $key ) ?>" <?php selected( $default_font_subset, $key ); ?>><?php esc_html_e( $subset ); ?></option>
                    <?php  endforeach; ?>
                </select>
            </div>
        ...
        <form method="post" class="page-step">
            <div>
                ...
                <select id="nbdesigner_create_your_own_page_id" name="nbdesigner_create_your_own_page_id" class="wc-enhanced-select">
                    ...
                    <option value="<?php esc_attr_e( $key ); ?>" <?php selected( $nbdesigner_create_your_own_page_id, $key ); ?>><?php esc_html_e( $page ); ?></option>
                    <?php  endforeach; ?>
                </select>   
                ...
                <select id="nbdesigner_designer_page_id" name="nbdesigner_designer_page_id" class="wc-enhanced-select">
                    <?php foreach( $pages as $key => $page ): ?>
                    <option value="<?php esc_attr_e( $key ); ?>" <?php selected( $nbdesigner_designer_page_id, $key ); ?>><?php esc_html_e( $page ); ?></option>
                    <?php  endforeach; ?>
                </select>    
                ...
                <select id="nbdesigner_gallery_page_id" name="nbdesigner_gallery_page_id" class="wc-enhanced-select">
                    <?php foreach( $pages as $key => $page ): ?>
                    <option value="<?php esc_attr_e( $key ); ?>" <?php selected( $nbdesigner_gallery_page_id, $key ); ?>><?php esc_html_e( $page ); ?></option>
                    <?php  endforeach; ?>
                </select>    
                ...
                <select id="nbdesigner_logged_page_id" name="nbdesigner_logged_page_id" class="wc-enhanced-select">
                    <?php foreach( $pages as $key => $page ): ?>
                    <option value="<?php esc_attr_e( $key ); ?>" <?php selected( $nbdesigner_logged_page_id, $key ); ?>><?php esc_html_e( $page ); ?></option>
                    <?php  endforeach; ?>
                </select>
            </div>
            <p class="nbd-setup-actions step">

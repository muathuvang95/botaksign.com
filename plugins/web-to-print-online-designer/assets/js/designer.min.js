...
//        };         
    ...
    $scope.startUploadDesign = function(){
        ...
        $scope.upload = $upload.upload({
            ...
            data: {
                ...
                "item_id"       :   NBDESIGNCONFIG['item_id'],           // BOTAK custom reupload Phase 3             
                "reupload"      :   NBDESIGNCONFIG['reupload'],          // BOTAK custom reupload Phase 3                    
    ...
    $scope.deleteUploadfile = function( index ){
        ...
        formData.append('file', JSON.stringify($scope.listFileUpload[index]));
        jQuery.ajax({
            url: NBDESIGNCONFIG['ajax_url'],
            method: "POST",
            dataType: 'json',
    ...
    $scope.completeUpload = function(){
        if( NBDESIGNCONFIG['task'] == "reup" ){
            ...
            if(NBDESIGNCONFIG['reupload'] == 'reupload') {                        // BOTAK custom reupload Phase 3  
                window.location = NBDESIGNCONFIG['redirect_url'];
                return;
            }
            $scope.saveCart();

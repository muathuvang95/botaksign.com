...
$_enable_design_help            = get_post_meta($pid, '_nbdesigner_enable_design_help', true); //CS botak
...
<div class="nbdesigner_frontend_container">
    ...
    <?php else: ?>
        <div class="nbd-actions-wrap">
            ...
            <div class="nbd-action-wrap" id="startUp">
                <a class="button alt nbdesign-button upload-design" id="startUpload">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path fill="#394264" d="M19.35 10.04C18.67 6.59 15.64 4 12 4 9.11 4 6.6 5.64 5.35 8.04 2.34 8.36 0 10.91 0 14c0 3.31 2.69 6 6 6h13c2.76 0 5-2.24 5-5 0-2.64-2.05-4.78-4.65-4.96zM14 13v4h-4v-4H7l5-5 5 5h-3z"></path></svg>
                    <span><?php esc_html_e('Upload Directly', 'web-to-print-online-designer'); ?></span>
                </a>
            </div>
            <?php endif; ?>
            <?php if( !$_enable_upload_without_design ): ?>
            <div class="nbd-action-wrap" id="startDe">
                <a class="button alt nbdesign-button start-design" id="startDesign">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path fill="#394264"  d="M23 7V1h-6v2H7V1H1v6h2v10H1v6h6v-2h10v2h6v-6h-2V7h2zM3 3h2v2H3V3zm2 18H3v-2h2v2zm12-2H7v-2H5V7h2V5h10v2h2v10h-2v2zm4 2h-2v-2h2v2zM19 5V3h2v2h-2zm-5.27 9h-3.49l-.73 2H7.89l3.4-9h1.4l3.41 9h-1.63l-.74-2zm-3.04-1.26h2.61L12 8.91l-1.31 3.83z"/></svg>
                    <span><?php esc_html_e('Upload via Editor', 'web-to-print-online-designer'); ?></span>
                </a>
            </div>
            <?php endif; ?>
            <?php if( $show_button_use_our_template ): ?>
            <div class="nbd-action-wrap" id="useTemplateBox">
                <a class="button alt nbdesign-button start-design" id="useTemplate" href="<?php echo $template_gallery_url;?>">
                    <svg xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 0 24 24" width="24"><path fill="#394264" d="M21 8V7l-3 2-3-2v1l3 2 3-2zm1-5H2C.9 3 0 3.9 0 5v14c0 1.1.9 2 2 2h20c1.1 0 1.99-.9 1.99-2L24 5c0-1.1-.9-2-2-2zM8 6c1.66 0 3 1.34 3 3s-1.34 3-3 3-3-1.34-3-3 1.34-3 3-3zm6 12H2v-1c0-2 4-3.1 6-3.1s6 1.1 6 3.1v1zm8-6h-8V6h8v6z"/></svg>
...
<div id="container-online-designer" data-iframe="<?php echo esc_url( $src ); ?>">
    ...
    <?php
       ...
       if(get_post_meta($pid, '_designer_upload_cs', true)  ) {
...
<script>
    jQuery(document).ready(function($) {
        ...
        var actions_warp = $('.nbdesigner_frontend_container .nbd-actions-wrap .nbd-action-wrap');
        var actions = $('.nbdesigner_frontend_container .nbd-actions-wrap .nbd-action-wrap');
        $.each( actions_warp , function( index, value ) {
            if (index == 2) {
                actions.css('width', '33.33%');
            }else if (index == 1){
        ...
        jQuery('.submit-upload-design').on('click', function (e){

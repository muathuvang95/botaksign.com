    ...
    <div class="layout__item__inner" id="<?php echo $btn_id; ?>">
        <div class="item__layout custom_design">
            ...
            <div class="tile__text-wrap">
                <div class="tile__text-wrap-inner" style="display: flex;">
                    <h3 class="h__block" style="margin-top: auto; margin-bottom: auto; padding-bottom: 2px;"><?php esc_html_e('Need design help?', 'web-to-print-online-designer'); ?></h3>                                          
                </div>

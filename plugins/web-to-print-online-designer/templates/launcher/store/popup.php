    ...
    <div class="nbdl-popup-inner">
        ...
        <div class="nbdl-popup-content">
            ...
            <div class="nbdl-popup-products">
                ...
                <div class="nbdl-product-wrapper" data-id="<?php esc_attr_e( $product['product_id'] ); ?>" data-upload="<?php esc_attr_e( $product['allow_upload_solid'] ); ?>">
                    <a>
                        <div class="nbdl-product-image-container">
                            <img class="nbdl-product-img" src="<?php echo esc_url( $product['src'] ); ?>" alt="<?php esc_attr_e( $product['name'] ); ?>" />
                        </div>
                    ...
                    <div class="nbdl-product-text">
                        <div class="nbdl-product-name"><?php esc_attr_e( $product['name'] ); ?></div>
                    </div>
                </div>
                <?php endforeach; ?>
            </div>

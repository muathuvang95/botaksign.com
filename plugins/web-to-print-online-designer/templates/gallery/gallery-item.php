...
<?php
    ...
    foreach ( $templates as $key => $temp ):
        ...
        $gallery_type = 1;
?>
    <div class="nbdesigner-item" data-id="<?php esc_attr_e( $temp['tid'] ); ?>" data-img="<?php esc_attr_e( $temp['image'] ); ?>" data-title="<?php esc_attr_e( $temp['title'] ); ?>">
        <div class="nbd-gallery-item">
            <div class="nbd-gallery-item-inner">
                <a href="<?php echo esc_url( $link_template ); ?>" onclick="previewTempalte(event, <?php esc_attr_e( $temp['tid'] ); ?>)">
            ...
            <div class="nbd-gallery-item-acction">
                ...
                <div class="nbd-like-icons">
                    <span class="nbd-like-icon like <?php if(in_array($temp['tid'], $favourite_templates)) echo 'active'; ?>" onclick="updateFavouriteTemplate(this, 'unlike', <?php esc_attr_e( $temp['tid'] ); ?>)">
                    ...
                    <span class="nbd-like-icon unlike <?php if(!in_array($temp['tid'], $favourite_templates)) echo 'active'; ?>" onclick="updateFavouriteTemplate(this, 'like', <?php esc_attr_e( $temp['tid'] ); ?>)">
                        <svg version="1.1" xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20">
                            <title>Voted</title>

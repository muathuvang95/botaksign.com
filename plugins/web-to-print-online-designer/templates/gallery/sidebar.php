...
<!-- <div class="nbd-designers nbd-sidebar-con">
    ...
    <div class="nbd-sidebar-con-inner">
        ...
        ?>
        <a href="<?php echo esc_url( $link_designer ); ?>" class="nbd-tag"><span><?php esc_html_e( $artist_name ); ?></span></a>
        <?php endforeach; ?>
    </div>
</div> -->
<div class="nbd-designers nbd-sidebar-con">
...
<div class="nbd-designers nbd-sidebar-con">
    ...
    <div class="nbd-sidebar-con-inner wishlist">
        ...
        <div class="wishlist-tem-wrap" data-id="<?php esc_attr_e( $t['id'] ); ?>">
            <div class="left" onclick="previewTempalte(event, <?php esc_attr_e( $t['id'] ); ?>)">

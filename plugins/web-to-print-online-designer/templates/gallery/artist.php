...
<div class="nbd-user-infos">
    <div class="nbd-user-banner">
        ...
        <img src="<?php echo esc_url( $banner_url ); ?>" alt="<?php esc_attr_e( $user_infos['nbd_artist_name'] ); ?>" />
        <?php endif; ?>
...
<div class="nbd-edit-tem-wraper">
    <div class="nbd-edit-tem-wrap">
        <div>
            ...
            <input value="<?php esc_attr_e( $design->id ); ?>" name="id" id="name" type="hidden"/>
            <input value="<?php esc_attr_e( $user_id ); ?>" name="user_id" id="user_id" type="hidden"/>
        ...
        <div class="nbd-template-form">
            <p class="nbd-form-title">
                ...
                <input value="<?php esc_attr_e( $design->name ); ?>" name="name" id="name" placeholder="<?php esc_attr_e( $product_name ); ?>" <?php  if( $current_user_id !=  $user_id ) echo 'disabled'; ?> />
            </p>
            <?php  if( $current_user_id ==  $user_id ): ?>
            ...
            <div class="nbd-thumbnail">
                <div class="image-wrap<?php echo ( $design->thumbnail ? '' : ' nbd-hide' ); ?>">
                    ...
                    <img class="nbd-thumbnail-img" src="<?php echo esc_url( $thumbnail ); ?>" alt="<?php esc_attr_e( $design->name ); ?>" />
            ...
            <div>
                ...
                <div class="nbd-preview-wrap">
                    <img class="nbd-preview" src="<?php echo esc_url( $image_url ); ?>" alt="<?php esc_attr_e( $design->name ); ?>" />
                </div>
                <?php endforeach; ?>
            </div>

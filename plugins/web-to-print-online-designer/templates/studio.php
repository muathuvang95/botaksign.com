...
<div class="studio-product-wrap">
    ...
    <div class="studio-product" data-id="<?php esc_attr_e( $product['product_id'] ); ?>" data-template="0" data-collapse="0">
        <div class="studio-product-inner">
            <div class="studio-product-img-wrap">
                <img class="product-img" src="<?php echo esc_url( $product['src'] ); ?>" alt="<?php esc_attr_e( $product['name'] ); ?>" />
            </div>
            <a href="<?php echo esc_url( $product['url'] ); ?>" target="_blank"><?php esc_html_e( $product['name'] ); ?></a>
        </div>

...
nbd_define('NBDESIGNER_VERSION', '2.7.0');
nbd_define('NBDESIGNER_NUMBER_VERSION', 270);
...
nbd_define('NBDESIGNER_TEMP_DIR', NBDESIGNER_DATA_DIR . '/design-templates');
nbd_define('NBDESIGNER_LOG_DIR', NBDESIGNER_DATA_DIR . '/logs');
nbd_define('NBDESIGNER_TEMP_URL', NBDESIGNER_DATA_URL . '/design-templates');
...
require_once(NBDESIGNER_PLUGIN_DIR . 'vendor/autoload.php');
...
if( nbdesigner_get_option('nbdesigner_disable_nonce') == 'yes' ){

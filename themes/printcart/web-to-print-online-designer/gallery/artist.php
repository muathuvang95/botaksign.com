...
<div class="nbd-user-banner  <?php if($user_infos['nbd_artist_banner'] != ''):?> banner_img <?php endif; ?> <?php if(printcart_get_options('nbcore_template_designer_style')){ echo printcart_get_options('nbcore_template_designer_style'); } ?>" <?php if($user_infos['nbd_artist_banner'] != ''):?>style="border-radius: 0;background-image: url(<?php echo $banner_url;?>)<?php endif; ?>">
    ...
    <?php endif; ?>
    <?php if(printcart_get_options('nbcore_template_designer_style') == 'style3'){?>
        <div class="container">
            <div class="row">
            <div class="nbd-user-infos <?php if(printcart_get_options('nbcore_template_designer_style')){ echo printcart_get_options('nbcore_template_designer_style'); } ?>">
                ...
                <div class="nbd-user-info">
                    ...
                    <div class="nbd-designer-info">
                        ...
                        <div class="nbd-social-list">
                            ...
                            <a class="nbd-social" href="<?php echo $user_infos['nbd_artist_linkedin']; ?>" title="<?php _e('Linkedin', 'web-to-print-online-designer'); ?>">
                            <i class="pt-icon-linkedin"></i>
                            </a>    
                            <?php  endif; ?>  

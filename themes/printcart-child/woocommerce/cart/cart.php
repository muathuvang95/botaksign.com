            ...
            <div class="row row-action">
                <div class="product-edit">
                    <?php
                        ...
                        $edit_html = '<a href="%s" class="remove" aria-label="%s" data-product_id="%s" data-product_sku="%s">'.$svg_edit.' Edit</a>';
                ...
                <div class="product-remove">
                    ...
                    $remove_html = '<a href="%s" class="remove" aria-label="%s" data-product_id="%s" data-product_sku="%s">'.$svg_trash.' Remove</a>';
                    echo apply_filters(// phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped

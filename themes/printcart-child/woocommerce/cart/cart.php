        ...
        <div class="action-table">
            <div class="row row-price">
                <div class="product-quantity" data-title="<?php esc_attr_e('Quantity', 'woocommerce'); ?>">
                    <p class="title"><?php esc_attr_e('Quantity', 'woocommerce'); ?></p>
                    <?php
                ...
                <div class="col-lg-8 col-6 mb-1">
                    <div class="btk-product-edit btk-btn-light mb-1">
                        <?php
                            $link = add_query_arg(
                                array(
                            ...
                            echo apply_filters(// phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
                                'woocommerce_cart_item_edit_link', sprintf(
                                    $edit_html, $link, esc_html__('Edit this item', 'woocommerce'), esc_attr($product_id), esc_attr($_product->get_sku())
                                ), $cart_item_key
                            );
                        ?>
                    </div>
                    <div class="btk-product-remove btk-btn-light mr-1 mb-1">
                        <?php
                    ...
                    <div class="btk-product-remove btk-btn-light mb-1" data-toggle="collapse" data-target=".btk-collapse-<?php echo esc_attr($cart_item_key); ?>" aria-expanded="false" aria-controls="btk-collapse-<?php echo esc_attr($cart_item_key); ?>-left btk-collapse-<?php echo esc_attr($cart_item_key); ?>-right">

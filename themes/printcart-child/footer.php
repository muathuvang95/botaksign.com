...
<footer id="colophon" class="nbfooter-mobile site-footer nbmobile-footer">
    ...
    if (printcart_get_options('nbcore_show_footer_bot')):
        ...
        <?php if (is_active_sidebar('footer-top-1') || is_active_sidebar('footer-top-2') || is_active_sidebar('footer-top-3') || is_active_sidebar('footer-top-4')): ?>
            ...
            <div class="footer-bot-section ">
                <div class="container">
                    <div class="row z-index <?php if (printcart_get_options('nbcore_footer_heading_up')) {
            echo 'uppercase';
        } ?> <?php if (printcart_get_options('nbcore_footer_list_style') == false) {
                    echo 'listnone';
                } ?>">
                        <?php
...
?>
    <div class="footer-abs-section">
        <div class="container">
            <div class="row">
                <div class="logo-wrapper-f col-sm-6 text-center">
                    <?php printcart_get_site_logo(); ?>
                </div>
                <div class="col-sm-6 footer-abs-content">
                    <?php
...
<footer id="colophon" class="nbfooter-desk site-footer">
<?php if (printcart_get_options('nbcore_show_footer_top')) { ?>
        <div class="footer-top-section">
